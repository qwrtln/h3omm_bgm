...
> @pwabuilder/pwaupdate they make this dead simple, the sw.js + manifest.json do most of the work for the PWA side of things thanks to that team.

#### 3. Do you own any of these assets?

> HECK NO! These are ALL copyrighted works. Most is owned by Ubisoft, some are fan made (Cove), and some are from the board game (Archon).

#### 4. What's the license actually cover then?

> Just the source code of this repo.

#### 5. Can you add or change something?
